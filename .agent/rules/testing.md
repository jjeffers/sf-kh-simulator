...
2. **Command:** `godot --headless --path . -s addons/gut/gut_cmdline.gd` (or your specific test runner command). (see "Run the full test suite" in the test_runner.md worklow.)
